...
return [
    ...
    // The release version of your application — uses git SHA, CI_COMMIT_SHA, or fallback
    'release' => env('SENTRY_RELEASE', trim(exec('git --git-dir ' . base_path('.git') . ' log --pretty="%h" -n1 HEAD 2>/dev/null') ?: 'unknown')),
