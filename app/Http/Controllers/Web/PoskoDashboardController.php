...
use App\Services\PoskoDashboardService;
...
class PoskoDashboardController extends Controller
{
    ...
    public function __construct(PoskoDashboardService $dashboardService)
    {
    ...
    public function index()
    {
        ...
        return view('dashboard.posko', compact('initialData'));
    }
