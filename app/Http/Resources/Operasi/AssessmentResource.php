    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'dampak_lingkungan' => $this->whenLoaded('dampakLingkungan', fn() => [
                ...
                'tingkat_kerusakan_lingkungan'   => $this->dampakLingkungan->tingkat_kerusakan_lingkungan,
                'butuh_rehabilitasi_lahan'       => (bool)($this->dampakLingkungan->butuh_rehabilitasi_lahan ?? false),
                'catatan_lingkungan'             => $this->dampakLingkungan->catatan_lingkungan,
            ]),
            'dampak_ekonomi' => $this->whenLoaded('dampakEkonomi', fn() => [
                'kerugian_perumahan'      => $this->dampakEkonomi->kerugian_perumahan,
                'kerugian_pertanian'      => $this->dampakEkonomi->kerugian_pertanian,
                'kerugian_peternakan'     => $this->dampakEkonomi->kerugian_peternakan,
                'kerugian_perikanan'      => $this->dampakEkonomi->kerugian_perikanan,
                'kerugian_umkm'           => $this->dampakEkonomi->kerugian_umkm,
                'kerugian_infrastruktur'  => $this->dampakEkonomi->kerugian_infrastruktur,
                'kerugian_lainnya'        => $this->dampakEkonomi->kerugian_lainnya,
                'estimasi_kerugian_total' => $this->dampakEkonomi->estimasi_kerugian_total,
                'mata_pencaharian_hilang' => $this->dampakEkonomi->mata_pencaharian_hilang,
                'usaha_terdampak'         => $this->dampakEkonomi->usaha_terdampak,
                'metodologi_estimasi'     => $this->dampakEkonomi->metodologi_estimasi,
